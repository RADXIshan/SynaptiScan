...
export default function HandwritingTest() {
  ...
  return (
    <div className="max-w-4xl mx-auto animate-fade-in-up">
      ...
      <div className="glass rounded-3xl p-8 relative overflow-hidden flex flex-col h-[700px]">
        <header className="flex items-center justify-between mb-6 z-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-bold text-white">Spiral Drawing Test</h1>
              <p className="text-slate-400 text-sm mt-1">Trace an outward spiral starting from the center.</p>
            </div>
          </div>
          <button onClick={clearCanvas} className="p-2 text-slate-400 hover:text-white bg-slate-800 rounded-lg transition-colors">
            <RotateCcw size={20} />
          </button>
        </header>
        ...
        {loading ? (
          <div className="flex-1 flex flex-col items-center justify-center text-center z-10">
            ...
            <h2 className="text-2xl font-bold text-white mb-2">Analyzing Strokes...</h2>
          </div>
        ) : (
          <div className="flex-1 bg-slate-900/50 rounded-2xl border border-slate-700 relative overflow-hidden cursor-crosshair flex items-center justify-center">
            <canvas 
              ref={canvasRef}
